...
#    add a sidecar <id>.meta.json in the same directory (manifest.jsonl is not committed; CI derives it from the meta files and publishes it as the `manifest` artifact): {"id":"...","sha256":"...","received_at":"...","door":"pr"}
